/*! For license information please see app.72f23163.js.LICENSE.txt */ ! function() {
    "use strict";
    var t, e = {
            9774: function(t, e, n) {
                n(4124), n(8981), n(9749), n(6544), n(8373), n(4254), n(6793), n(8077), n(9693), n(752), n(6203), n(9730), n(4284), n(7629), n(7509), n(8052), n(5399), n(228), n(3964), n(4043), n(1694), n(9873), n(8436), n(7522), n(6265);
                var r = n(9883);
                ...
                function i() {
                    ...
                    function j(e, n, r) {
                        ...
                        return function(i, a) {
                            ...
                            for (r.method = i, r.arg = a;;) {
                                ...
                                var s = d(e, n, r);
                                if ("normal" === s.type) {
                                    if (o = r.done ? m : p, s.arg === g) continue;
                                    return {
                                        value: s.arg,
                                        done: r.done
                                    }
                    ...
                    return b.prototype = E, a(S, "constructor", {
                        value: E,
                        configurable: !0
                    }), a(E, "constructor", {
                        value: b,
                        configurable: !0
                    }), b.displayName = f(E, l, "GeneratorFunction"), e.isGeneratorFunction = function(t) {
                        var e = "function" == typeof t && t.constructor;
                        return !!e && (e === b || "GeneratorFunction" === (e.displayName || e.name))
                    }, e.mark = function(t) {
                        return Object.setPrototypeOf ? Object.setPrototypeOf(t, E) : (t.__proto__ = E, f(t, l, "GeneratorFunction")), t.prototype = Object.create(S), t
                    }, e.awrap = function(t) {
                        return {
                            __await: t
                        }
                    ...
                    }, C(S), f(S, l, "Generator"), f(S, c, (function() {
                        return this
                        ...
                        finish: function(t) {
                            for (var e = this.tryEntries.length - 1; e >= 0; --e) {
                                ...
                                if (n.finallyLoc === t) return this.complete(n.completion, n.afterLoc), G(n), g
                            }
                        },
                        catch: function(t) {
                            for (var e = this.tryEntries.length - 1; e >= 0; --e) {
                ...
                n(9373), n(4338), n(9772), n(7049), n(2506), n(9903), n(9288), n(9358), n(2826);
                var f = function() {
                        function t(e) {
                            var n, r, o = e.maxReelItems,
                                i = void 0 === o ? 30 : o,
                                a = e.removeWinner,
                                u = void 0 === a || a,
                            ...
                            ! function(t, e) {
                            ...
                            }(this, t), this.nameList = [], this.havePreviousWinner = !1, this.reelContainer = document.querySelector(c), this.maxReelItems = i, this.shouldRemoveWinner = u, this.onSpinStart = s, this.onSpinEnd = l, this.onNameListChanged = f, this.reelAnimation = null === (n = this.reelContainer) || void 0 === n ? void 0 : n.animate([{
                                transform: "none",
                                filter: "blur(0)"
                            }, {
                                filter: "blur(1px)",
                                ...
                                duration: 100 * this.maxReelItems*1.5,
                                easing: "ease-in-out",
                                iterations: 1,
                        ...
                        return e = t, n = [{
                            ...
                            set: function(t) {
                                var e;
                                this.nameList = t, ((null === (e = this.reelContainer) || void 0 === e ? void 0 : e.children) ? Array.from(this.reelContainer.children) : []).forEach((function(t) {
                                    return t.remove()
                                ...
                                return i().wrap((function(e) {
                                    for (;;) switch (e.prev = e.next) {
                                        ...
                                        case 7:
                                            ...
                                            return u = u.slice(0, this.maxReelItems - Number(this.havePreviousWinner)), c = document.createDocumentFragment(), u.forEach((function(t) {
                                                var e = document.createElement("div");
                                                e.innerHTML = t, c.appendChild(e)
                                            })), n.appendChild(c), o && this.nameList.splice(this.nameList.findIndex((function(t) {
                                                return t === u[u.length - 1]
                                            })), 1), s = new Promise((function(t) {
                                                r.onfinish = t
                                            })), r.play(), e.next = 18, s;
                                        case 18:
                                            return r.finish(), Array.from(n.children).slice(0, n.children.length - 1).forEach((function(t) {
                                                return t.remove()
                                            })), this.havePreviousWinner = !0, this.onSpinEnd && this.onSpinEnd(), e.abrupt("return", !0);
                                        case 23:
                                        case "end":
                                            return e.stop()
                                    }
                ...
                var v = function() {
                    function t() {
                        ...
                        ! function(t, e) {
                            if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
                        }(this, t), (window.AudioContext || window.webkitAudioContext) && (this.audioContext = new(window.AudioContext || window.webkitAudioContext)), this.isMuted = e
                    }
                    var e, n;
                    return e = t, n = [{
                        key: "mute",
                            ...
                            if (c) {
                                ...
                                var f = c.currentTime,
                                    d = t.reduce((function(t, e) {
                                        var n = e.key,
                                            r = e.duration;
                                        return s.frequency.setValueAtTime(h[n], f + t), t + r
                                    }), 0);
                                i && (l.gain.exponentialRampToValueAtTime(u, f + d - .1), l.gain.exponentialRampToValueAtTime(.01, f + d)), s.start(f), s.stop(f + d)
                            }
                        }
                    }, {
                        key: "win",
                        ...
                        value: function(t) {
                            ...
                            var e = [{
                                ...
                                r = Math.floor(10 * t);
                            return this.playSound(Array.from(Array(r), (function(t, n) {
                                return e[n % 3]
                            })), {
                                type: "triangle",
                                easeOut: !1,
                    ...
                    }], n && y(e.prototype, n), Object.defineProperty(e, "prototype", {
                        writable: !1
                    }), t
                }();
                ...
                function g() {
                    ...
                    function O(t, e) {
                        function n(o, i, a, u) {
                            ...
                            if ("throw" !== c.type) {
                                var s = c.arg,
                                    l = s.value;
                                return l && "object" == m(l) && r.call(l, "__await") ? e.resolve(l.__await).then((function(t) {
                                    n("next", t, a, u)
                                }), (function(t) {
                                    n("throw", t, a, u)
                    ...
                    function j(e, n, r) {
                        ...
                        return function(i, a) {
                            ...
                            for (r.method = i, r.arg = a;;) {
                                ...
                                var s = f(e, n, r);
                                if ("normal" === s.type) {
                                    if (o = r.done ? p : d, s.arg === v) continue;
                                    return {
                                        value: s.arg,
                                        done: r.done
                                    }
                    ...
                    function A(e, n) {
                        var r = n.method,
                            o = e.iterator[r];
                        if (o === t) return n.delegate = null, "throw" === r && e.iterator.return && (n.method = "return", n.arg = t, A(e, n), "throw" === n.method) || "return" !== r && (n.method = "throw", n.arg = new TypeError("The iterator does not provide a '" + r + "' method")), v;
                    ...
                    return b.prototype = E, o(S, "constructor", {
                        value: E,
                        configurable: !0
                    }), o(E, "constructor", {
                        value: b,
                        configurable: !0
                    }), b.displayName = s(E, c, "GeneratorFunction"), e.isGeneratorFunction = function(t) {
                        var e = "function" == typeof t && t.constructor;
                        return !!e && (e === b || "GeneratorFunction" === (e.displayName || e.name))
                    }, e.mark = function(t) {
                        return Object.setPrototypeOf ? Object.setPrototypeOf(t, E) : (t.__proto__ = E, s(t, c, "GeneratorFunction")), t.prototype = Object.create(S), t
                    }, e.awrap = function(t) {
                        return {
                            __await: t
                        }
                    }, C(O.prototype), s(O.prototype, u, (function() {
                        return this
                    })), e.AsyncIterator = O, e.async = function(t, n, r, o, i) {
                        void 0 === i && (i = Promise);
                    ...
                    }, C(S), s(S, c, "Generator"), s(S, a, (function() {
                        return this
                        ...
                        finish: function(t) {
                            for (var e = this.tryEntries.length - 1; e >= 0; --e) {
                                var n = this.tryEntries[e];
                                if (n.finallyLoc === t) return this.complete(n.completion, n.afterLoc), G(n), v
                            }
                        },
                        catch: function(t) {
                            for (var e = this.tryEntries.length - 1; e >= 0; --e) {
                ...
                function w(t, e, n, r, o, i, a) {
                    ...
                    if (t && e && n && o && i && a && u && c && s && l && h && d)
                        if (s instanceof HTMLCanvasElement) {
                            var y, p = new v,
                                m = ["#26ccff", "#a25afd", "#ff5e7e", "#88ff5a", "#fcff42", "#ffa62d", "#ff36ff"],
                                b = r.Z.create(s, {
                                    resize: !0,
                                    useWorker: !0
                                }),
                                E = function t() {
                                    var e = window.innerWidth || document.documentElement.clientWidth || document.getElementsByTagName("body")[0].clientWidth,
                                        n = Math.max(.5, Math.min(1, e / 1100));
                                    b({
                                        particleCount: 1,
                                        gravity: .8,
                                        spread: 90,
                                        ...
                                        colors: [m[Math.floor(Math.random() * m.length)]],
                                        scalar: n
                                    }), y = window.requestAnimationFrame(t)
                                },
                                x = function() {
                                    y && window.cancelAnimationFrame(y), c.style.display = "none"
                                },
                                L = function() {
                                    var e, r = (e = g().mark((function e() {
                                        return g().wrap((function(e) {
                                            for (;;) switch (e.prev = e.next) {
                                                case 0:
                                                    return E(), c.style.display = "block", e.next = 4, p.win();
                                                case 4:
                                ...
                                k = new f({
                                    ...
                                    onSpinStart: function() {
                                        x(), t.disabled = !0, n.disabled = !0, p.spin(3.9)
                                    },
                                    onSpinEnd: L,
                                    onNameListChanged: x
                                }),
                                S = function() {
                                    l.value = k.names.length ? k.names.join("\n") : "", h.checked = k.shouldRemoveWinnerFromNameList, d.checked = !p.mute, o.style.display = "block"
                                },
                                C = function() {
                            ...
                            })), document.documentElement.requestFullscreen && document.exitFullscreen || e.remove(), e.addEventListener("click", (function() {
                                document.fullscreenElement ? document.exitFullscreen && document.exitFullscreen() : document.documentElement.requestFullscreen()
                            })), n.addEventListener("click", S), a.addEventListener("click", (function() {
                                k.names = l.value ? l.value.split(/\n/).filter((function(t) {
                                    return Boolean(t.trim())
                                })) : [], k.shouldRemoveWinnerFromNameList = h.checked, p.mute = !d.checked, C()
                    ...
                    navigator.serviceWorker.register("./service-worker.js").then((function(t) {})).catch((function(t) {}))
                }))
            }
        },
        n = {};
    ...
    r.m = e, t = [], r.O = function(e, n, o, i) {
            if (!n) {
                ...
                for (l = 0; l < t.length; l++) {
                    ...
                    for (var u = !0, c = 0; c < n.length; c++)(!1 & i || a >= i) && Object.keys(r.O).every((function(t) {
                        return r.O[t](n[c])
                    })) ? n.splice(c--, 1) : (u = !1, i < a && (a = i));
                    if (u) {
                        t.splice(l--, 1);
                        var s = o();
                        void 0 !== s && (e = s)
